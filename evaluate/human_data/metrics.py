...
def main():
    models_list = ["Vicuna", "Mistral", "Zephyr", "OpenChat", "Snorkel", "Llama3", "Starling", "StarlingCode", "Gemma", "Qwen"]
    contest_data = read_json_to_list(f'human_contest_data.json')
    elo_scores = calculate_elo(models_list, contest_data)
    write_dict_to_json(elo_scores, f'human_elo_scores.json')
